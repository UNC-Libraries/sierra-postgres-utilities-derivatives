module Sierra
  module Derivatives
    class HathitrustRecord < DerivativeRecord
      attr_reader :ia
      ...
      def initialize(sierra_bib, ia_record)
        ...
        warn('No Sierra record present') if @sierra.nil?

        warn('Sierra bib for this bnum was deleted') if @sierra&.deleted?
      end
      ...
      def check_record
        ...
        # check oclc 035s
        # this needs to be @altmarc rather than @smarc because @smarc does not
        # contain 035s we've written from an 001
